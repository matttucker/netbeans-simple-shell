...
public class CommandTokenizer {
     ...
     */
    CommandTokenizer(String s, char c) {
        this(s);
    ...
    private String ReadString() {
        ...
        while (index != length) {
            if (isWhitespace(str.charAt(index))) {
                ...
                // mkt
                // check if there is a preceding back slash in front of the space
    ...
    public static String[] ParseArgs(String command) {
        CommandTokenizer token = new CommandTokenizer(command);
    ...
    public static String[] ParseArgs(String command, char c) {
        CommandTokenizer token = new CommandTokenizer(command, c);
        return token.ParseTokens(-1);
    }
