...
public class ShellBlockHighlighting extends AbstractHighlightsContainer implements HighlightsChangeListener {

    private static final Logger LOG = Logger.getLogger(ShellBlockHighlighting.class.getName());
    private String layerId;
    private JTextComponent component;
    private Document document;
    private PositionsBag bag;

    public ShellBlockHighlighting(String layerId, JTextComponent component) {
        this.layerId = layerId;
        this.component = component;
        this.document = component.getDocument();

        this.bag = new PositionsBag(document, false);
...
//        FontColorSettings fcs = MimeLookup.getLookup(MimePath.parse(getMimeType())).lookup(FontColorSettings.class);
//        AttributeSet attribs = fcs.getFontColors(coloringName);

        SimpleAttributeSet errorAttribute = new SimpleAttributeSet();
        StyleConstants.setFontFamily(errorAttribute, "SansSerif");
        StyleConstants.setFontSize(errorAttribute, 12);
        StyleConstants.setForeground(errorAttribute, Color.blue);
